...
import fr.esilv.mythsandgods.ViewPager.DivinityFragment;
import fr.esilv.mythsandgods.ViewPager.MonsterFragment;
import fr.esilv.mythsandgods.ViewPager.SummaryCategoryFragment;
import fr.esilv.mythsandgods.ViewPager.WebViewFragment;


public class ViewPagerAdapterDivinity extends FragmentStatePagerAdapter {
    private int tabCount;
    private String website;
    private String title;
    private String[] tabTitles = new String[] {"Site", "Résumé"};

    public ViewPagerAdapterDivinity(FragmentManager fm, int tabCount, String website, String title) {
        super(fm);
